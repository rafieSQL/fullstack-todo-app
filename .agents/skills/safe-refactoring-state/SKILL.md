---
name: safe-refactoring-state
description: Rules for Single Source of Truth architecture, atomic refactoring, Supabase mutation hygiene, and verification checks.
---
